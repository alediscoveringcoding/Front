// TypeScript declarations for stubbed packages

declare module 'lucide-react' {
  import * as React from 'react';
  export const ChevronDownIcon: React.ForwardRefExoticComponent<any>;
  export const CheckIcon: React.ForwardRefExoticComponent<any>;
  export const XIcon: React.ForwardRefExoticComponent<any>;
  ...
  export const PanelLeftIcon: React.ForwardRefExoticComponent<any>;
  export const MinusIcon: React.ForwardRefExoticComponent<any>;
  export const SearchIcon: React.ForwardRefExoticComponent<any>;
  export const CircleIcon: React.ForwardRefExoticComponent<any>;
...
declare module 'embla-carousel-react' {
  import * as React from 'react';
  type UseEmblaCarouselType = [React.RefObject<any>, any];
  function useEmblaCarousel(...args: any[]): UseEmblaCarouselType;
  export default useEmblaCarousel;
  export type UseEmblaCarouselType = UseEmblaCarouselType;
}
...
declare module 'react-hook-form' {
  ...
  export function FormProvider(...args: any[]): React.ComponentType<any>;
